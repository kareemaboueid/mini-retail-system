...
confirm_password: eud_user_confirm_password,
    ...
    _request.checkBody('first_name', 'First name is required').notEmpty();
    _request.checkBody('last_name', 'Last name is required').notEmpty();
    _request.checkBody('email_address', 'Email address is required').notEmpty();
    _request.checkBody('phone_number', 'Phone number is required').notEmpty();
    _request.checkBody('job_position', 'Job position is required').notEmpty();
    _request.checkBody('nationallity', 'Nationallity is required').notEmpty();
    _request.checkBody('civil_id', 'Civil ID is required').notEmpty();
    _request.checkBody('username', 'Username is required').notEmpty();
    _request.checkBody('password', 'Password is required').notEmpty();
    _request.checkBody('confirm_password', 'Confirm password is required').notEmpty();
...
data_user_password : eud_user_password,
    ...
    _response
      ...
      .json(hlp_jsend(StatusCodes.CREATED, {message: `User ${eud_user_username} created successfully`}))
